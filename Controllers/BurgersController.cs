...
namespace AndresGuaman_EjercicioCF.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public BurgersController(AndresGuaman_EjercicioCFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'AndresGuaman_EjercicioCFContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AndresGuaman_EjercicioCFContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
